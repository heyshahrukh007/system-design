...
[← API Gateway Responsibilities](./04-api-gateway-responsibilities.md) | [Day 8 Index](./README.md) | [Next: Authentication and Authorization →](./06-authentication-and-authorization.md)
...
See [Day 3: Load Balancer](../day-03/03-load-balancer.md).
