...
[← Rate Limiting at Gateway](./07-rate-limiting-at-gateway.md) | [Day 8 Index](./README.md) | [Next: Client-Side vs Server-Side Discovery →](./09-client-side-vs-server-side-discovery.md)
