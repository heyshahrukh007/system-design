...
[← Query Execution](./06-query-execution.md) | [Day 4 Index](./README.md) | [Next: ORM →](./08-orm.md)
...
In microservices, avoid distributed transactions — use [sagas](../day-03/09-microservices-and-workers.md).
