...
[← Connection Pooling](./10-connection-pooling.md) | [Day 4 Index](./README.md) | [Next: Sharding →](./12-sharding.md)
...
See also [Day 3: DB Scaling](../day-03/07-db-scaling.md) for when to add replicas in your scaling roadmap.
