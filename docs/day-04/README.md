# Day 4 — Database Internals

Day 3 showed how to **scale** databases from the outside. Day 4 goes **inside** — how data is stored, queried, and managed at the engine level.
...
- [Day 3: DB Scaling](../day-03/07-db-scaling.md)
