...
[← Authentication and Authorization](./06-authentication-and-authorization.md) | [Day 10 Index](./README.md) | [Next: Service Discovery →](./08-service-discovery.md)
...
Use rate limit at **gateway** for client-facing APIs. Use **queue** for internal job buffering ([Day 8](../day-08/README.md)).
