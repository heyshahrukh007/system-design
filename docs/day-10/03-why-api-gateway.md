...
[← Service-to-Service Communication](./02-service-to-service-communication.md) | [Day 10 Index](./README.md) | [Next: API Gateway Responsibilities →](./04-api-gateway-responsibilities.md)
...
Gateway is **application-aware** reverse proxy. See [Day 5: Reverse Proxy](../day-05/03-reverse-proxy.md).
...
Often: **Gateway** → **BFF** → microservices for large orgs.
