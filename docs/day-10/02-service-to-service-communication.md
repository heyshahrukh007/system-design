...
[← Monolith vs Microservices](./01-monolith-vs-microservices.md) | [Day 10 Index](./README.md) | [Next: Why API Gateway →](./03-why-api-gateway.md)
...
See [Day 8: Sync vs Async](../day-08/03-sync-vs-async-communication.md).
...
| Fire-and-forget events | Kafka, SQS ([Day 8](../day-08/README.md)) |
...
Every service call needs reliability patterns from [Day 9](../day-09/README.md):
...
**REST** for public and general use. **gRPC** for fast internal RPC. **GraphQL** for flexible client queries at the gateway. **Queues** for async. Combine sync calls with Day 9 reliability patterns and authenticate every hop.
