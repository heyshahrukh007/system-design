...
[← Why Caching](./01-why-caching.md) | [Day 7 Index](./README.md) | [Next: Where to Place Cache →](./03-where-to-place-cache.md)
...
| DB buffer pool | Database server RAM ([Day 6](../day-06/01-storage-basics.md)) |
...
A cache is a **temporary, fast, in-memory copy** of data from a slower source. It's not a database — it doesn't replace durable storage. It exists purely to make repeated reads cheap. Understanding hit/miss and volatility sets up every pattern in the rest of Day 7.
