...
[← What Is a Cache](./02-what-is-a-cache.md) | [Day 7 Index](./README.md) | [Next: What to Cache →](./04-what-to-cache.md)
...
See [Day 4: Browser](../day-04/01-visit-website-scenario.md#step-2--browser) and [Day 5: CDN](../day-05/04-cdn.md).

---

## Layer 2 — CDN Cache

Cached on edge servers worldwide. See [Day 5: CDN](../day-05/04-cdn.md).
...
Hot **data pages** kept in RAM. See [Day 6: Storage Basics](../day-06/01-storage-basics.md).
