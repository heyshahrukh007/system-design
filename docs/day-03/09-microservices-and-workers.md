...
[← Queue](./08-queue.md) | [Day 3 Index](./README.md)
...
**Workers** are background processes that consume tasks from a [queue](./08-queue.md) and do work outside the request path.
...
Real production stack from the [request journey](./01-request-journey.md), fully scaled:
