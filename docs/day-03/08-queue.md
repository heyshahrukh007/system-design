...
[← DB Scaling](./07-db-scaling.md) | [Day 3 Index](./README.md) | [Next: Microservices & Workers →](./09-microservices-and-workers.md)
...
From the [request journey](./01-request-journey.md) — after order placement:
...
[Next: Microservices & Workers →](./09-microservices-and-workers.md)
