...
[← Caching](./06-caching.md) | [Day 3 Index](./README.md) | [Next: Queue →](./08-queue.md)
...
See [Caching](./06-caching.md). Redis in front of DB cuts read load dramatically.
